...
import { ThemeMode, SudokuState, Coordinates } from '../../types';
...
interface SudokuProps {
  ...
  gameState: SudokuState | undefined;
  setGameState: (state: SudokuState) => void;
}
...
const Sudoku: React.FC<SudokuProps> = ({ onBack, currentTheme, soundEnabled, gameState, setGameState }) => {
  ...
  const handleNumberInput = (num: number) => {
      ...
      if (gameState.isNoteMode) {
          ...
          if (newBoard[r][c] === num) return; // Same number
      ...
      <div className="w-full flex justify-between items-center pb-2 border-b border-opacity-20 border-gray-500 shrink-0">
         ...
         <div className="flex gap-2 text-xs items-center">
             <select 
                ...
                onChange={(e) => startNewGame(e.target.value as any)}
