...
import { ThemeMode, TextAdventureState, ChatMessage } from '../../types.ts';
import { themes } from '../../utils/themes.ts';
import { playSound } from '../../utils/sound.ts';
import { generateAdventureResponse } from '../../services/geminiService.ts';

interface TextAdventureProps {
  onBack: () => void;
  currentTheme: ThemeMode;
  soundEnabled: boolean;
  gameState: TextAdventureState | undefined;
  setGameState: (state: TextAdventureState) => void;
}

const TextAdventure: React.FC<TextAdventureProps> = ({ 
